...
func Getuniqueusernames(ctx context.Context, c *app.RequestContext) {
	...
	resp, err := DoGetuniqueusernames(ctx, cli, string(st)) // Pass the generic client and requestContext
	if err != nil {
